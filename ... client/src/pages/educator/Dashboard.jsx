  ...
  return dashboardData ? (
    ...
    md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        p-4 w-56 rounded-md'>
          <img src={assets.user} alt='userlogo' className='h-8 w-8'/>
          <div>
         ...
         <div className='flex items-center gap-3 shadow-card border border-blue-500
        p-4 w-56 rounded-md'>
          <img src={assets.pagess} alt='page' className='h-8 w-8'/>
          <div>
         ...
         <div className='flex items-center gap-3 shadow-card border border-blue-500
        p-4 w-56 rounded-md'>
          <img src={assets.earning} alt='earninglogo' className='h-8 w-8'/>
          <div>
              ...
              {dashboardData.enrolledStudentsData.map((item,index)=>(
                <tr key={index} className='border-b border-gray-500/20'>
                    ...
                    <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
                      <img src={assets.learn} alt='logo' className='w-9 h-9 rounded-full'/>
