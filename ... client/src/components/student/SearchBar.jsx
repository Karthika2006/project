...
const SearchBar = ({data}) => {
  ...
  return (
    <form onSubmit={onSearchHandler} className='max-w-xl w-ful l md:h-14 h-12 flex items-center bg-white 
    border border-gray-500/20 rounded'>
      <img src={assets.searchicon} alt="searchicon" className='w-10 md:
      w-10 mx-6'/>
