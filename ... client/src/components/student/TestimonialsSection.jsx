...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h1 className='text-3xl font-medium text-gray-800'>Testimonails</h1>
      ...
      <div className='grid grid-cols-auto gap-8 mt-14'>
        {dummyTestimonial.map((testimonial, index)=>(
          ...
          pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5
          overflow-hidden'>
              ...
              <div>
                ...
                <div className='p-5 pb-7'>
                  <div className='flex gap-0.5'>
                    {[...Array(5)].map((_,i)=>(
                      <img className='h-5' key={i} src={i < Math.floor(testimonial.rating) ? assets.
                        star : assets.star_blank} alt='star' />
                    ))}
                </div>
